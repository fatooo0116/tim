...
function Render_all_box() {
    ...
    var a = $container.find(".type1").eq(0).width(),
        b = $container.width();
    if (b > 768) var c = Math.floor(.01 * b / 2) - 1;
    else if (768 > b > 450) var c = Math.floor(.01 * b) - 1;
    else c = 5;
    if (450 > b) {
        var d = $(".type2_journal_top");
        if (d.length > 0) {
            var e = $("article"),
                f = e.eq(1).remove();
            $("#wdr_inner").prepend(f)
    ...
    gunit = a, ggutter = c;
    var g = $container.find("article.type_work");
    if (g.length > 0) {
        var h = 250 + Number(c);
        h = h * w_height - c, g.css("height", h)
    }
    var i = $container.find("article.type_jouranl");
    if (i.length > 0) {
        var h = 250 + Number(c);
        h = h * j_height - c, i.css("height", h)
    }
    $container.find("article").each(function() {
        ...
        if (b.length > 0) {
            ...
            var c = a.find("img").attr("src"),
                d = a.find(".content").attr("bk_pos");
            a.find(".content").css({
                background: "url(" + c + ") no-repeat center " + d,
                "background-size": "cover"
            })
        }
    }), $container.find("article").each($container.width() > 768 ? function() {
        var a = Math.floor(2 * gunit);
        ...
        $(this).css("margin-bottom", c), $(this).find(".sep").css({
            width: c
        })
    } : function() {
        if ($(this).hasClass("type4")) {
...
var $ = jQuery,
    ...
    gunit = 0,
    ggutter = 0,
    w_height = $("article.type_work").attr("tbox_size");
0 == Number(w_height) && (w_height = 4);
var j_height = $("article.type_jouranl").attr("tbox_size");
0 == Number(j_height) && (j_height = 4),

jQuery(document).ready(function(a) {
    function b() {
        a("#language  li a").on("click", function() {
            "cht" == a(this).attr("title") ? Cookies.set("wdr_lang", "cht", {
                expires: 1
            }) : Cookies.set("wdr_lang", "chn", {
                expires: 1
            })
        })
    }
    Render_all_box();
    var c = (a(window).width(), a(window).height()),
        d = a("#wdr_content").width(),
        e = a(".super_banner");
    e.length > 0 && (c -= 100, e.css("height", c), a("nav").css("background", "none"), a("nav .navbar-collapse").css("opacity", "0"), 610 > c && e.find(".table_inner").css({
        "vertical-align": "top",
        "padding-top": "20px"
    }), e.find(".close_banner").bind("click", function(b) {
        b.preventDefault(), e.animate({
            top: "-1600px"
        }, 1300, function() {
            a("nav").css("background", "#fff"), a("nav .navbar-collapse").css("opacity", "1")
        })
    }), a("#wdr_inner").css({
        width: d,
        position: "fixed"
    })), a(window).scrollTop(0), a(window).scroll(function() {
        var b = a(this).scrollTop();
        b > 120 ? (e.hasClass("out") || (e.addClass("out"), e.css("position", "absolute"), e.animate({
            top: "-1600px"
        }, 500, function() {
            a("nav").css("background", "#fff"), a("nav .navbar-collapse").css("opacity", "1"), setTimeout(function() {
                a(window).scrollTop(0), a("#wdr_inner").css({
                    width: "auto",
                    position: "static"
                })
            }, 300)
        })), a("header>nav").addClass("mini")) : a("header>nav").removeClass("mini")
    });
    ...
    */
    ...
    a(".info").each(function(){
        var b = a(this),
            c = b.parent(),
            d = Number(a(b).height()) + 20;
        a(b).animate({
            bottom: -d
        }, 100), c.on("mouseenter", function() {
            a(b).animate({
                bottom: "0"
            }, 100)
	...
	/*
    a("ul#language a").bind("click", function(b) {
        "cht" == a(this).attr("title") ? (tongwen_StoT(), b.preventDefault()) : "chn" == a(this).attr("title") && (tongwen_TtoS(), b.preventDefault())
    });
    */

    a("#wdr_content article.page_nav .left,article.page_nav .right").bind("click", function() {
    ...
    a.ajax({
        ...
        b(), "chn" == Cookies.get("wdr_lang") ? a('#language  li a[title="chn"]').trigger("click") : 2 != c && a('#language  li a[title="chn"]').trigger("click")
    });
...
/* CHT Version */
if(cur_page_cht.length>0){
    $("#language").find("a[title=\"eng\"]").attr("href",cur_page_cht);
}else{
    $("#language").find("a[title=\"eng\"]").attr("href","http://ddg.com.tw/en/");
}



//$('article.item').bind('touchstart touchend', function(e) {
  //  $(this).find(".mask").toggleClass('hover_effect');
//});



  $('article.item').bind('touchstart touchend', function(e){
    var infopanel = $(this).find(".info");
    ...
    $(this).find(".mask").addClass('hover_effect');
  });

  $('article.item').bind('touchend', function(e){
    var infopanel = $(this).find(".info");
    var  d = Number(a(b).height()) + 20;
    if(infopanel.length>0){
      infopanel.animate({
          bottom: -d
      }, 100);
    }
    $(this).find(".mask").removeClass('hover_effect');
  });
...
$(window).resize(function() {
    clearTimeout(_timerVar), _timerVar = setTimeout("resizeUI()", 500)
});
